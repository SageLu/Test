...
public class CurveGraph {
	...
	private String[] coordinateTitleArr=null;
	...
	public CurveGraph(String name, int color, float[] coordinateArr,String[] coordinateTitleArr) {
		this.name = name;
		this.color = color;
		this.setCoordinateArr(coordinateArr);
		this.setCoordinateTitleArr(coordinateTitleArr);
	}
	...
	public String[] getCoordinateTitleArr() {
		return coordinateTitleArr;
	}

	public void setCoordinateTitleArr(String[] coordinateTitleArr) {
		this.coordinateTitleArr = coordinateTitleArr;
	}
}
