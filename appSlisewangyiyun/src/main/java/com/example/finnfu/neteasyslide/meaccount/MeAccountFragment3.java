 ...
 */
public class MeAccountFragment3 extends Fragment {
    private ViewPager mainViewPager3;
    private MeAccountFragmentAdapter_3 adapter;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        adapter = new MeAccountFragmentAdapter_3(getChildFragmentManager());
