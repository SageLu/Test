 ...
 */
public class MeAccountFragmentAdapter_4 extends FragmentPagerAdapter{
    private static final String[] TITLE = new String[] { "昨日", "本月", "上月"};
    private ArrayList<Fragment> fragmentArrayList;
    private Fragment mainFragment1;
    private Fragment mainFragment2;
    private Fragment mainFragment3;

    public MeAccountFragmentAdapter_4(FragmentManager fm) {
        super(fm);
        mainFragment1 = new MeAccount4_Fragment1();
        mainFragment2 = new MeAccount4_Fragment2();
        mainFragment3 = new MeAccount4_Fragment3();
