 ...
 */
public class MeAccountFragmentAdapter_3 extends FragmentPagerAdapter{
    ...
    public MeAccountFragmentAdapter_3(FragmentManager fm) {
        super(fm);
        mainFragment1 = new MeAccount3_Fragment1();
        mainFragment2 = new MeAccount3_Fragment2();
        mainFragment3 = new MeAccount3_Fragment3();
