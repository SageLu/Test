 ...
 */
public class MeAccountFragmentAdapter_1 extends FragmentPagerAdapter{

    private ArrayList<Fragment> fragmentArrayList;
    private Fragment mainFragment1;
    private Fragment mainFragment2;
    private Fragment mainFragment3;
    private static final String[] TITLE = new String[] { "个性推荐", "歌单", "主播电台"};
    public MeAccountFragmentAdapter_1(FragmentManager fm) {
        super(fm);
        mainFragment1 = new MeAccount1_Fragment1();
        mainFragment2 = new MeAccount1_Fragment2();
        mainFragment3 = new MeAccount1_Fragment3();
